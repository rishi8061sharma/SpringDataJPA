...
public class JLCAppConfig {
	...
	@Bean(name = "myHelloExchange") 
	 ...
	 return ExchangeBuilder.directExchange("myhello-exchange-1").build(); 
	 } 
	 ...
	 @Bean 
	 Binding helloBinding1(Queue myHelloQueue1, DirectExchange myHelloExchange) { 
	 ...
	 @Bean 
	 Binding helloBinding2(Queue myHelloQueue2, DirectExchange myHelloExchange) { 
	 ...
	 @Bean 
	 Binding helloBinding3(Queue myHelloQueue3, DirectExchange myHelloExchange) { 
