...
public class AccountController {
 ...
 @ApiOperation(value = " get the Balance", 
		 response = double.class, notes = "Gives Balance of Customer with Accno") 
@GetMapping("/mybal/{accno}") 
 ...
 @ApiOperation(value = " get the Account Information", 
		 response = Account.class, notes = "Gives Complete Account Information with Accno") 
 ...
 @ApiOperation(value = " get All Accounts Information", 
		 response = List.class, notes = "Gives  All the Accounts Information") 
 ...
 @ApiOperation(value = " Adds Account Info", 
		 response = Account.class, notes = "Adds Accounts Information") 
 ...
 @ApiOperation(value = " Updates Account Info", 
		 response = String.class, notes = "Updates  Accounts Information") 
@PutMapping(value = "/updateAccount")
 ...
 @ApiOperation(value = " Delete Account Info", 
		 response = String.class, notes = "Delete  Accounts Information") 
